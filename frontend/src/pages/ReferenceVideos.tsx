...
const ReferenceVideos = () => {
    ...
    const [category, setCategory] = useState('참고 영상')
    ...
    if (loading) {
        return (
            <div className="pt-40 pb-20 min-h-screen flex items-center justify-center">
                <div className="text-white/30 font-black animate-pulse tracking-widest uppercase">Syncing Reference Data...</div>
            </div>
        )
    }
            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                    <div>
                        ...
                        <p className="text-white/50 text-lg font-medium">전문 시술 분석 및 동력 과학 참고 영상을 탐독하십시오.</p>
                    </div>
